...
(function() {
    ...
    function assemble_flipbox(el) {
        ...
        var b = '<div class="btn-back"><p'+ hb + '>这是一个推广链接，你确定要浏览它吗？</p><button class="yes">确定</button><button class="no">取消</button></div>';
    ...
    function hlpl() {
        $("#content_left").children().each(function() {
            ...
            if (typeof c != 'undefined') {
                ...
                } else if (typeof c.rsv_cd != 'undefined') {
                    if (/vLevel:\d/.test(c.rsv_cd)) assemble_flipbox($(this));
                }
            } else {
